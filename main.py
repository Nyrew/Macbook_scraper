from spider.scraper import scrape_alza_parallel, scrape_istyle_parallel
from spider.config import CONFIG_ALZA, XPATH_PRODUCT_PRICE_ALZA, CONFIG_ISTYLE, XPATH_PRODUCT_PRICE_ISTYLE, XPATH_COOKIES_BUTTON_ISTYLE

def main():
    updated_configs_alza = scrape_alza_parallel(CONFIG_ALZA, XPATH_PRODUCT_PRICE_ALZA)
    updated_configs_istyle = scrape_istyle_parallel(CONFIG_ISTYLE, XPATH_PRODUCT_PRICE_ISTYLE, XPATH_COOKIES_BUTTON_ISTYLE)
    print(updated_configs_alza)
    print(updated_configs_istyle)
...
#         )
#         scraped_data_alza = scrape_alza_parallel(CONFIG_ALZA, XPATH_PRODUCT_PRICE_ALZA)
